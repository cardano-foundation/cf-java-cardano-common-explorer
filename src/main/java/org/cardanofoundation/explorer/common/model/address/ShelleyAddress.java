package org.cardanofoundation.explorer.common.model.address;
...
public class ShelleyAddress extends Address {
  ...
  public String getBech32DelegationPart() {
    ...
    return Bech32.encode(
        concat(getBech32Prefix(this.getNetwork()), delegationPart), delegationPrefix);
  }
