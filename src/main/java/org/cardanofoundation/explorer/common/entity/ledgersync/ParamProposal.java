...
import org.cardanofoundation.explorer.common.entity.validation.Lovelace;
import org.cardanofoundation.explorer.common.entity.validation.Word31Type;
import org.cardanofoundation.explorer.common.entity.validation.Word64Type;
...
public class ParamProposal extends BaseEntity {
  ...
  public int hashCode() {
    return getHashCode(minFeeA)
        ...
        + getHashCode(pvtMotionNoConfidence)
        + getHashCode(pvtCommitteeNormal)
        + getHashCode(pvtCommitteeNoConfidence)
        + getHashCode(pvtHardForkInitiation)
        + getHashCode(pvtPPSecurityGroup)
        + getHashCode(dvtMotionNoConfidence)
        + getHashCode(dvtCommitteeNormal)
        + getHashCode(dvtCommitteeNoConfidence)
        + getHashCode(dvtUpdateToConstitution)
        + getHashCode(dvtHardForkInitiation)
        + getHashCode(dvtPPNetworkGroup)
        + getHashCode(dvtPPEconomicGroup)
        + getHashCode(dvtPPTechnicalGroup)
        + getHashCode(dvtPPGovGroup)
        + getHashCode(dvtTreasuryWithdrawal)
        + getHashCode(committeeMinSize)
        + getHashCode(committeeMaxTermLength)
        + getHashCode(govActionLifetime)
        + getHashCode(govActionDeposit)
        + getHashCode(drepDeposit)
        + getHashCode(drepActivity)
